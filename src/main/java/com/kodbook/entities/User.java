...
//	@OneToMany(mappedBy = "user", cascade = CascadeType.ALL, orphanRemoval = true)
	...
	//check if user can enter username password ans email while sign up 
	...
	public User(Long id, String username, String email, String password, String dob, String gender, String city,
			String bio, String college, String linkedIn, String gitHub, List<Comment> comments, List<Post> posts,
			byte[] profilePic) {
		super();
		this.id = id;
		this.username = username;
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", email=" + email + ", password=" + password + ", dob="
				...
				+ ", linkedIn=" + linkedIn + ", gitHub=" + gitHub +", comments=" + comments +  ", posts=" + posts + ", profilePic="
